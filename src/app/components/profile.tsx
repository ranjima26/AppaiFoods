...
const buttonClass = "inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-[#008846] px-6 text-sm font-bold text-white transition-colors hover:bg-[#003820]";
